...
public class SiteUserAdditionResponseDTO {
	...
	public SiteUserAdditionResponseDTO() {
		super();
	}
	...
	public SiteUserAdditionResponseDTO(String userId, String userName, String password, String familyName,
