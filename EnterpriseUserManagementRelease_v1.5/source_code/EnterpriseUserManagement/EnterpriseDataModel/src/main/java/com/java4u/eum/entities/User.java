...
public class User {
	...
	@Id
	@GeneratedValue(generator = "es_user_id_generator")
	@GenericGenerator(name = "es_user_id_generator", strategy = "com.altiux.eum.entities.idgenerator.UserIdGenerator")
	@Column(name = "userId")
	...
	@ElementCollection
	@CollectionTable(name = "UserEmails", joinColumns = @JoinColumn(name = "userId") )
	private List<Email> emails = new ArrayList<Email>();

	@ElementCollection
	@CollectionTable(name = "UserPhoneNumbers", joinColumns = @JoinColumn(name = "userId") )
	...
	@ElementCollection
	@CollectionTable(name = "permittedOperations", joinColumns = @JoinColumn(name = "userId") )
	...
	public User(String userId, String userName, String password, String familyName, String middleName, String givenName,
